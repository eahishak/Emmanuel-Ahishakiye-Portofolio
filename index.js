...
document.addEventListener('DOMContentLoaded', function () {
    ...
    { src: 'img/gallery/11.jpg', description: 'With Friends at BrownCroft Community Church' },
    ...
    { src: 'img/gallery/16.jpg', description: 'Conesius Lake| Finger Lakes' },
    ...
    { src: 'img/gallery/44.jpg', description: 'Family' },
    { src: 'img/gallery/45.jpg', description: 'Family' }
    ];
